  ...
  var body: some Scene {
    WindowGroup {
      ...
      .onAppear {
        ...
        print(
          "renee we disabled notifications builder but you cant delete anything else until you get it back its the next line below right here:"
        )
        notificationsBuilder.scheduleNotifications(
          reminderData: data.reminderData, medData: data.medData)
