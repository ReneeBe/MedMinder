...
//                    Button(action: {
//                        indices.sort(by: >)
//                        let newReminder = Reminder(medName: med.name, intakeType: intakeType, intakeTime: delete() ?? Foundation.Date(), intakeAmount: Double(dosage), delay: Int(delay), allowSnooze: allowSnooze, notes: notes)
...
//                        createOrUpdateReminder(med: med, reminder: newReminder, name: med.name)
//
...
//    }
//
//    func createOrUpdateReminder(med: Med, reminder: Reminder, name: String ) {
//        data.createReminderRecord(med: med, reminder: reminder)
//    }
